...
/***
 *主页→咨询
 * 点击搜索框跳转至搜索页面（SearchActivity）
 */

public class MainActivityHomepageConsultationFragment extends Fragment implements View.OnClickListener{
...
//        slideShowView=(SlideShowView)this.rootView.findViewById(R.id.homepage_slide_show);
        ...
        adapter=new CommonAdapter<Article>(getContext(), R.layout.item_article, ArticleArrayList){
            ...
            public void convert(ViewHolder holder, final Article data) {
                ...
                LinearLayout skip_to_info=holder.getView(R.id.skip_to_info);
