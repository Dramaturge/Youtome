...
//        String E1 = "[\u4e00-\u9fa5]";// 中文
    ...
    public static class ActionMenu extends LinearLayout {
        ...
        private void init() {
            ...
            setBackgroundDrawable(getResources().getDrawable(R.drawable.menu));
            mMenuItemMargin = 10;
        }
        ...
        private View createMenuItem(final String itemTitle) {
            ...
            LayoutParams params = new LayoutParams(160, 80);
            ...
            menuItem.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.menu_item));
